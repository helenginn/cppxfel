...
void FileParser::generateHelpList()
{
    ...
    helpMap["INITIAL_RLP_SIZE"] = "Size of theoretical Miller index (0, 0, 0) in reciprocal space distance (Å-1). Default 0.0001 Å-1.";
