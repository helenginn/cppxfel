...
void FileParser::generateDeprecatedList()
{
	...
	deprecatedList["DETECTOR_GAIN"] = "Don't specify a gain in the input script. Specify it in the detector panel for the geometry file.";
}
...
void FileParser::generateHelpList()
{
	...
	helpMap["OVER_PRED_RLP_SIZE"] = "Reciprocal lattice point radius in Å-1 at the Miller index position (0, 0, 0) (i.e. without consideration of mosaicity). Default 1 × 10-3 Å-1. If you aren't picking up all your spots at low resolution, please use this.";
